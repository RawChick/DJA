...
$query = "INSERT INTO text_reports(titel, tekst) VALUES ('$titel', '$text');";
$result = mysqli_query($link, $query);

if ($result === true) { 
    
    echo "<b><h4><u>Verslag toegevoegd</u></h4></b>"; 
} else { 
...
?>
					<content>
						...
						<form action="addcontent.php" method="post" class="formulier">
				<br>
				...
				<input name="titel" type="text" id="titel"><br><br>
					...
					<label><big><b>Verslag</b></big></label>
