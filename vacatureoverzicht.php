...
$query = "SELECT id, title, datum FROM jobs ORDER BY datum DESC";
$result = mysqli_query($link, $query);
setlocale(LC_TIME, array('nl_NL.UTF-8','nl_NL@euro','nl_NL','dutch'));
?>
                        <h2><b>Vacature overzicht</b></h2>
                    </header>
...
$myDate = date($time );
        ...
        <tr>
        <td>
      <a href='deletevacancy.php?id=".$row['id']."'><img src='images/delete_icon.png' width='25px'></a>
        </td>
        <td>
        ".$row['title']."
        </td>
