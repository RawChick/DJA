...
<div class= "bottomcontent">
				...
				<article class="mainbar">	
					<header>
						<h2><b>Algemene regels voor jeugdwedstrijden</b></h2>
					</header>
...
<ul>
<li>Opgeven kan via je train(st)er. De vetgedrukte wedstrijden op de kalender zijn met begeleiding. Let op dat je op tijd inschrijft, graag minimaal 2 weken voor wedstrijddatum.</li>
