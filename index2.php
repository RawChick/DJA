...
?>
	...
	<div id="page" class="container">
		<div id="content">
			<div class="title">
				<h2>Nieuws</h2>
				<span class="byline">Blijf altijd op de hoogte met het laatste nieuws</span> </div>
			<ul class="style3">
				<li class="first">
...
<div id="portfolio-wrapper">
		<div id="portfolio" class="container">
			<div id="column1">
				...
				<a href="fotoalbum.php" class="icon icon-arrow-right button"><div class="readmore"><img src="includes/images/white-arrow-right.png">  Ga naar album</div></a> </div>
			<div id="column2">
				<div class="title">
					<h2>Nieuw bij DJA?</h2>
				</div>
				<div class="emptydiv">
				<p>Atletiek vereniging De Jonge Athleet  </p></div>
				<a href="nieuwdja.php" class="icon icon-arrow-right button"><div class="readmore"><img src="includes/images/white-arrow-right.png">  Read More</div></a> </div>
			...
			<div id="column3">
				...
				<a href="#" class="icon icon-arrow-right button"><div class="readmore"><img src="includes/images/white-arrow-right.png">  Lees meer</div></a> </div>
			...
			<div id="column4">
				...
				<?php include('includes/sponsorslide.php'); ?> </div></div>
				<a href="sponsorlijst.php" class="icon icon-arrow-right button"><div class="readmore"><img src="includes/images/white-arrow-right.png">  Sponsor overicht</div></a> </div>
		</div>
	</div>
