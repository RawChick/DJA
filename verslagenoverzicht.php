...
$query = "SELECT id, titel, datum FROM text_reports ORDER BY datum DESC";
$result = mysqli_query($link, $query);
setlocale(LC_TIME, array('nl_NL.UTF-8','nl_NL@euro','nl_NL','dutch'));
?>
                        <h2><b>Verslagen overzicht</b></h2>
                    </header>
...
$myDate = date($time );
        ...
        <tr>
        <td>
      <a href='deletereport.php?id=".$row['id']."'><img src='images/delete_icon.png' width='25px'></a>
        </td>
        <td>
        ".$row['titel']."
        </td>
