		...
		<header>
			...
			if (empty($_SESSION['myemail'])) {
				...
				if ($function == 'Admin' || $function == 'Trainer' || $function == 'Bestuur' || $function == 'RSC'){
					?>
					<h2><b>Voeg nieuws-item toe</b></h2>
				</header>
				<?php
				...
				if ( isset($aErrors) && count($aErrors) == 0)
				{
					...
					$query = "INSERT INTO news(titel, article) VALUES ('$titel', '$text');";
					$result = mysqli_query($link, $query);
					if ($result === true) { 
						
						echo "<b><h4><u>Nieuws-item toegevoegd</u></h4></b>"; 
					} else { 
			...
			?>
			<content>
				<form action="addnews.php" method="post" class="formulier">
					<br>
