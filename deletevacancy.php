...
if (!isset($_GET['id']))
{
    echo 'Er is geen vacature geselecteerd';
    exit;
}
...
{
    echo "<p><b>Het verwijderen van de vacature is gelukt!</b></p>";
}
else
{
    echo "Er is iets fout gegaan met verwijderen, probeer alstublieft opnieuw.";
...
<meta http-equiv="refresh" content="3;url=vacatureoverzicht.php" />
<?php echo "<p><b>U wordt terug gebracht naar het vacature overzicht</b></p><br>";
