...
if (!isset($_GET['id']))
{
    echo 'Er is geen mededeling geselecteerd';
    exit;
}
...
{
    echo "<p><b>Het verwijderen van de mededeling is gelukt!</b></p>";
}
else
{
    echo "Er is iets fout gegaan met verwijderen, probeer alstublieft opnieuw.";
...
<meta http-equiv="refresh" content="3;url=mededelingoverzicht.php" />
<?php echo "<p><b>U wordt terug gebracht naar het mededelingoverzicht</b></p><br>";
