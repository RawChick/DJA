...
if (!isset($_GET['id']))
{
    echo 'Er is geen item geselecteerd';
    exit;
}
...
{
    echo "<p><b>Het verwijderen van het nieuws-item is gelukt!</b></p>";
}
else
{
    echo "Er is iets fout gegaan met verwijderen, probeer alstublieft opnieuw.";
...
<meta http-equiv="refresh" content="3;url=nieuwsoverzicht.php" />
<?php echo "<p><b>U wordt terug gebracht naar het nieuwsoverzicht</b></p><br>";
