...
<div class= "bottomcontent">
		  ...
		  De afkorting &quot;av DJA&quot; betekent: atletiek vereniging De Jonge Athleet.
    	  De vereniging is op 12 juni 1962 opgericht als specifieke atletiekvereniging.<br />
    	  Doelstelling: het bevorderen en het doen bevorderen van de atletiek en recreatieve sporten in 
    	  welke verschijningsvorm dan ook.<br />
    	  Sinds 1971 is er ook een recreatiesportafdeling bijgekomen.
    	  De vereniging is nog steeds groeiende, zowel kwantitatief als kwalitatief. 
    	  Er wordt technisch en recreatief getraind, er wordt gelopen, er wordt gewandeld. 
  	      Op alle leeftijdsniveau's en op verschillende dagen.
...
<h5>Buiten het bestuur heeft DJA nog verschillende commissies te weten:</h4>
    <ul>
        <li>Wedstrijdorganisatie WO (voorheen Technische Commissie)</li>
        <li>Recordcommissie</li>
        <li>Recreatiesportcommissie (RSC)</li>
        <li>Wedstrijdsecretariaat<br />
        </li>
    </ul>

<h4>Vertrouwenscontactpersoon:</h4>
	      Karin van den Broek, Burg. Manderslaan 41, 4881 EH&nbsp; Zundert. Tel. 06-11167667
...
<h4>Ledenadministratie:</h4>
      ...
      <strong>Afmelden</strong>: uitsluitend <strong>schriftelijk</strong> 
      	  ...
      	  <strong>Let op: DJA zal dit bedrag bij te late opzegging volledig in rekening brengen.</strong><br />
          Ook bestaat de mogelijkheid per 1 juli van het kalenderjaar op te zeggen. 
          Dit houdt in dat vóór 15 juni opgezegd moet worden om per 1 juli het lidmaatschap te kunnen beëindigen. <br />
  	  <strong>Attentie</strong>: het bondsgeld dat DJA aan de AU verschuldigd is over het lopende jaar blijft voor het 
  	  <strong>gehele kalenderjaar</strong> verschuldigd, dus ook bij opzegging per 1 juli.

<h4>Jubilea:</h4>
 	      Wij willen graag belangstelling tonen bij speciale gelegenheden zoals jubilea, huwelijk, geboorte en ook droevige omstandigheden. 
 	      Dit kan echter alleen als wij hiervan een berichtje ontvangen.<br />
          Dit kan via de trainer, recreatieleidster of aan Annie van Oijen, Griendweg 14, 4885 AE &nbsp;Achtmaal, tel. 076-5985700 
          <a href="mailto:annie.van.oyen@gmail.com">annie.van.oyen@gmail.com</a>

<h4>Jeugdco&ouml;rdinatie:</h4>
          Anouk Vermeiren, Nachtegaalstraat 32, 4881 VE&nbsp; Zundert, tel. 06-42258401<br />
