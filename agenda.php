...
$sql = "SELECT * FROM agenda WHERE `begindate` > SUBDATE(NOW(),1) OR `enddate` > SUBDATE(NOW(),1) ORDER BY `begindate`;";
...
{ 
  ...
  ?>
  <tr>
    <td colspan="2"><a href="pastagenda.php"><b>Bekijk hier verleden activiteiten..</b></a></td>
  </tr>
</table>
</div>
          </content>
