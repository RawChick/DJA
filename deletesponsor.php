...
$sql = "DELETE FROM sponsorbar WHERE id = ?";
...
if (!isset($_GET['id']))
{
    echo 'Er is geen sponsor geselecteerd';
    exit;
}
...
{
    echo "<p><b>Het verwijderen van de sponsor is gelukt!</b></p>";
}
else
{
    echo "Er is iets fout gegaan met verwijderen, probeer alstublieft opnieuw.";
...
<meta http-equiv="refresh" content="3;url=sponsoroverzicht.php" />
<?php echo "<p><b>U wordt terug gebracht naar het sponsoroverzicht</b></p><br>";
